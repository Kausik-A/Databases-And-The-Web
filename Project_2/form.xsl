        ...
        <html>
            ...
            <form action="">
                ...
                <xsl:for-each select="dataInputForm/textbox">
                    ...
                    <input type="text" id="{name/text()}" name="{name/text()}" maxlength='{maxlength/text()}' size='{size/text()}'></input> <br></br>
                    <br></br>
            ...
            <button type="submit" value="Submit"><xsl:value-of select="dataInputForm/submit/caption"/></button>
            <br></br>
            <br></br>
